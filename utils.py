...
class Factory:
    ...
    def create(cls, params: dict, **kwargs):
        type_id = params["type"] if isinstance(params, dict) and "type" in params else getattr(params, "type", cls.defaults()[0])
        obj_type = cls.registry()[type_id]
        p = params["params"] if isinstance(params, dict) and "params" in params else getattr(params, "params", params)
